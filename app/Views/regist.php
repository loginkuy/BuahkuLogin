        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <form id="form_daftar" action="<?= base_url('Up');?>" method="POST">
                        ...
                        <h6 class="mt-2 mb-2 h6">Sudah punya akun? <a class="text-decoration-none" href="<?= base_url('Login')?>">Login</a></h6>
