...
<head>
    ...
    <title>Login Admin | BuahKu</title>
</head>
        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <form id="form_daftar" action="<?= base_url('Admin/In');?>" method="POST">
                        <?php
                        ...
                        <h6 class="mt-3 mb-3 h6">Belum punya akun? <a class="text-decoration-none" href="<?= base_url('Admin/Regist')?>">Daftar</a></h6>
