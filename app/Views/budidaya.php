    ...
    <nav class="navbar navbar-expand-lg bg-pink fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <li class="nav-item">
                    <a class="nav-link active fw-bold" href="<?php echo base_url('Budidaya');?>" title="Budidaya" id="link-navbar">BUDIDAYA</a>
                </li>
                </ul>
...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 py-5 mt-2">
            <?php
            for ($i = 0; $i < count($budidaya); $i++) {
            // Baris baru setiap 4 data
            if ($i > 0 && $i % 4 == 0) {
            ...
            echo    '<div class="col-12 col-md-6 col-lg-3">
                        <div class="card" >
                            <a href="Budidaya/Detail/' . $budidaya[$i]['_id'] . '">
                            <img src="'.base_url('assets/images/produk/') . $budidaya[$i]['foto'] . '" class="card-img-top" alt="' . $budidaya[$i]['nama_produk'] . '">
                            
                            <div class="card-body">
                                <h5 class="card-title-budidaya" style="color:black;">' . $budidaya[$i]['nama_produk'] . '</h5>
                            </div>
                            </a>
                        </div>
                    </div>';
