...
<meta charset="UTF-8">
    ...
    <title>Detail Budidaya | BuahKu</title>
...
<body>
    ...
    <div class="container py-5">
        <h1 class="text-center" style="margin-top: -5%; padding-top: 5%;">Cara Budidaya Buah Lokal Indonesia</h1>

        <?php
        echo    '<div class="container-bag1" style="margin-bottom: -12%;">
                    <div class="wrapper">
                        <div class="text-box" style="text-align: justify;">
                            <h2>Budidaya ' . $budidaya[0]['nama_produk'] . '</h2>
                            <p>' . $budidaya[0]['deskripsi'] . '</p>
                            <p style="font-weight: 700; margin-bottom: 0;">Nama Latin &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <i>' . $budidaya[0]['nama_latin'] . '</i></p>
                            <p style="font-weight: 700; margin-bottom: 0;">Jenis Tanah Yang Tepat &nbsp;&nbsp;: ' . $budidaya[0]['tanah'] . '</p>
                            <p style="font-weight: 700; margin-bottom: 0;">Suhu Yang Tepat &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ' . $budidaya[0]['suhu'] . ' &#8451;</p><br>
                            <h3 style="font-size: 22px;">Langkah-Langkah Budidaya ' . $budidaya[0]['nama_produk'] . '</h3>'. $budidaya[0]['budidaya'] .
                        '</div>
                    </div>
                </div>';
