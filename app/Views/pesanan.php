    ...
    <section>
        <div class="container w-75">
            ...
            for ($i = 0; $i < count($pesanan); $i++) {
                if ($i > 0 && $i % 3 == 0) {
                    echo    '</div>
                            <div class="row row-cols-1 row-cols-md-4 py-3">';
                }
            echo                '<div class="col-lg-4">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <h6 class="card-text">' . $pesanan[$i]['tanggal'] . ' | ' . $pesanan[$i]['qty'] . ' Barang</h6>
                                            <h5 class="card-title">' . $pesanan[$i]['nama_produk'] . '</h5>
                                            <h6 class="card-text">' . $pesanan[$i]['status'] . '</h6>
                                        </div>
                                    </div>
                                </div>';
            }
